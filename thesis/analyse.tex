...
Die Knoten senden regelmäßig eine Inquiry Message aus, die dann von mobilen Einheiten in Reichweite mit einer Inquiry Response beantwortet werden. 
...
Ihre Knoten versenden regelmäßig Inquiry Messages und messen den RSSI der Inquiry Responses.
...
Allerdings messen sie dazu an den Knoten die empfangene Signalstärke von Übertragungen anderer Knoten, folglich kann die offline-Phase automatisiert durchgeführt werden.
...
Sie messen an den Knoten den RSSI von Advertising Paketen, die zuvor von den mobilen Einheiten versendet wurden.
