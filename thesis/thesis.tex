...
\hypersetup{
 pdfauthor={Marius Wodtke},
 pdftitle={Zuverlässige funkbasierte Bereichsortung im Tunnelbau}
 %pdfsubject={Zuverlässige funkbasierte Bereichsortung im Tunnelbau},
 pdfkeywords={802.11, WiFi, WLAN, Bluetooth Low Energy, LoRa, localisation}
}
...
\include{analyse}
\include{noChanges}
\include{softwareChanges}
\include{hardwareChanges}
\include{lora}
\include{fazit}
