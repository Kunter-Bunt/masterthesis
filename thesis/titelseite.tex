...
\vfill
{\usesf
{\huge\bfseries Zuverlässige funkbasierte Bereichsortung im Tunnelbau \par}
\vskip 1.8cm
Masterarbeit\\
von\\[2mm]
\vskip 1cm
...
Externer Betreuer: & Andreas Ratzke (Ed. Züblin AG)\\
\end{tabular}
\vskip 3cm
Bearbeitungszeit:\qquad 02.~Oktober~2017 -- 11.~Januar~2018
}
\end{center}
\vfill
\end{titlepage}
