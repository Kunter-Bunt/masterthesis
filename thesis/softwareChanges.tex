...
Tabelle \ref{radarconsumption} zeigt den gemessenen Verbrauch der Implementierung für RADAR Tags jeweils in Arduino und C, mit unterschiedlich langen Sendeintervallen und mit und ohne manuellen \texttt{light\_sleep}.
...
\end{verbatim}
Ein gewöhnlicher Probe Request beinhaltet noch zusätzliche Informationen bezüglich seiner technischen Möglichenkeiten, wie etwa unterstützde Standards und Datenraten, da das Tag aber nicht tatsächlich beitreten will kanndarauf verzichtet werden. \\
