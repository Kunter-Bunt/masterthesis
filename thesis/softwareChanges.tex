...
Der Stromverbrauch sollte sich somit kaum unterscheiden und ein System mit \emph{RADAR}-artigen mobilen Einheiten benötigt Veränderungen der Software der APs, ein System mit mobilen Einheiten für Bereichsortung ist deshalb vorzuziehen. 
...
Sie verbraucht deshalb sogar mehr Strom als die mobilen Einheiten für Bereichsortung aus Abschnitt \ref{ch:phase1:sec:anpassungbereich}, die Implementierung mit der ESP Open SDK verbraucht aber weniger Strom als diese.
...
\begin{figure}[h!]
  ...
  \caption{Stromverbrauchskurve einer Implementierung mit Probe Requests.}
...
\begin{figure}[h!]
  ...
  \caption{Stromverbrauchskurve eines Ortungsvorgangs mit Probe Requests.}
  \label{fig:probereqv}
\end{figure}
...
\begin{table}[h!]
	\centering
	\caption{Stromverbrauch mobiler Einheiten mit Probe Request Ortung}
...
\begin{figure}[h]
  ...
  \caption{LIS3DH integriert auf einer Platine für die Entwicklung. Bild von Adafruit Industries\protect \footnotemark.}
  \label{fig:lis3dh}
\end{figure}
