...
Dies geschieht üblicherweise über das Address Resolution Protokoll (ARP). [evtl IGMP?] \\%TODO Kai fragen.
...
Da dem Tag, welches im Sinne der 802.11 Spezifikation als Station arbeitet, die IP-Adresse seines Netztzugangs (Gateway) bekannt sein muss, diese Information kann dann als Ortungsinformation verwendet werden.
