...
\subsection{ESP8266}
Der \emph{ESP8266} soll als Hardware für das Tag eingesetzt werden, dabei handelt es sich um einen Microcontroller von Espressif Systems \footnote{\url{http://espressif.com/}}.
