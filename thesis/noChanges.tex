...
\begin{table}[h!]
	...
	\begin{tabular}{l|l|p{2.5cm}|p{2.5cm}}
		...
		\hline
		\emph{ESP8266} Feather & WiFi-LLS alle Kanäle & 42,2 & 33,2\\
		\emph{ESP-12F} & WiFi-LLS alle Kanäle & 36,5 & 38,3\\
		\emph{ESP8266} Feather & WiFi-LLS ein Kanal & 18,7 & 74,9\\
		\emph{ESP-12F} & WiFi-LLS ein Kanal & 11,4 & 122,8\\
	\end{tabular}
\end{table}
...
\begin{table}[h!]
	...
	\begin{tabular}{l|p{5cm}|p{2.5cm}|p{2.5cm}}
		...
		\hline
		\emph{ESP8266} Feather & \emph{Assoziations-Lokalisierung} TCP-Verbindung halten & 15,5 & 90,3\\
		\emph{ESP-12F} & \emph{Assoziations-Lokalisierung} TCP-Verbindung halten & 8,8 & 159,1\\
		\emph{ESP8266} Feather & \emph{Assoziations-Lokalisierung} TCP-Verbindung schließen & 15,4 & 90,9\\
		\emph{ESP-12F} & \emph{Assoziations-Lokalisierung} TCP-Verbindung schließen & 8,8 & 159,1\\
	\end{tabular}
\end{table}
