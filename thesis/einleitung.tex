...
Der Entwurfsraum umfasst dabei die Hardware und Software der mobilen Enheit sowie die Implementierung des Ortungsservers, die für die Funktechnologie benötigte Infrastruktur wird jeweils als gegeben angenommen.
...
Die Kapitel \ref{ch:phase1}, \ref{ch:phase2} und \ref{ch:phase3} beschäftigen sich mit der Implementierung und Untersuchung der Prototypen. 
