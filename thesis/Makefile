...
clean:
	- find . | egrep -v "\.(git|svn)" | egrep ".*((\.(aux|idx|ind|ilg|log|blg|bbl|toc|lof|lot|dvi|tlf|tlt))|~)$$" | xargs rm
...
latin1:
	...
	- @ for file in *.tex *.cls *.bst; do echo "converting $$file ..."; uconv -f utf-8 -t iso-8859-15 $$file -o $(ISO_8859_DIR)/$$file; done;
