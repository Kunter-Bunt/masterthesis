...
Da aber Informationen, die üblicherweise während des Verbindungsaufbaus übertragen werden, nun als Header um das Datenpaket gepackt werden müssen, sinkt die Bruttodatenrate von 2,1 Mbps (Bluetooth 4.0) auf 0,7 Mbps (Bluetooth Low Energy). %TODO cite
