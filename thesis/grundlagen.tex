...
Es handelt sich dabei jeweils um die Funktion des Entdeckens von Ressourcen mittels Inquiry für Bluetooth beziehungsweise mittels Beacon für BLE.
...
\begin{figure}[!b]
  \centering
	\includegraphics[width=0.5\textwidth]{images/inqscan.png}
