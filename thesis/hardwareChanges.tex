...
Nach einem Neustart der Arduino IDE kann im \textit{Boards Manager} das Paket Adafruit \emph{nRF52} installiert werden.
...
Nachdem das Board in der IDE ausgewählt und über USB mit dem Computer verbunden wurde, kann nun eigener Code oder eines der Beispiele aus \textit{Examples for Adafruit Bluefruit \emph{nRF52} Feather} mit STRG+U auf den \emph{nRF52} geladen werden.\\
Es wird die Bluefruit \emph{nRF52} API Version 0.6.0 verwendet.
...
\begin{table}[h!]
	...
	\begin{tabular}{p{3.5cm}|p{5cm}|p{2.5cm}|p{2.5cm}}
		...
		\hline
		\emph{nRF52} Feather & Bluetooth-Low-Energy-Advertising & 7,37 & 190\\
		\emph{nRF52} (projeziert) & Bluetooth-Low-Energy-Advertising & 0,32 & 4375\\
	\end{tabular}
\end{table}
