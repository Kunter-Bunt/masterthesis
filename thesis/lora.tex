...
\subsubsection{Theoretische Energieverbrauchsabschätzung}
...
\subsubsection{Tatsächlicher Energieverbrauch von LoRa}
...
Abbildung \ref{fig:lora5} zeigt den Lastverlauf für den Start einer mobilen Einheit mit LoRa bei 5dBm.\\
...
Die Abbildung \ref{fig:lora235send} zeigt die Sendeverbräuche für eine Sendeleistung von 23dBm in Rot und für 5dBm in Grün.
...
\begin{table}[h!]
	...
	\begin{tabular}{p{3.5cm}|p{5cm}|p{2.5cm}|p{2.5cm}}
		...
		\hline
		LoRa Feather & LoRa mit 23dBm Sendeleistung & 1,47 & 952,4\\
		LoRa Feather & LoRa mit 5dBm Sendeleistung & 1,2 & 1166,7\\
	\end{tabular}
\end{table}
