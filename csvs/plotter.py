...
ax1.plot(data['x']/1000, data['y'], color='r', marker='');
ax1.fill_between(data['x']/1000, data['y'], 0, facecolor='red', alpha=0.4, interpolate=True)
ax1.plot(data['x']/1000, data['z'], color='g', marker='');
