...
void init_ACC(void)
{
    ...
    writeRegister(0x20, 0xA7); //Write A7h into CTRL_REG1;      // Turn on the sensor, enable X, Y, Z axes with ODR = 100Hz normal mode. 8F for low power mode
    ...
    writeRegister(0x32, 0x14); //Write 10h into INT1_THS;          // Threshold (THS) = 16LSBs * 15.625mg/LSB = 250mg.
